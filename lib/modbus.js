exports.transports = {
	...
	tcpSerial: require('./transport/tcp-serial') 
};
...
exports.drivers = {
	...
	tcpSerial: require('./driver/tcp-serial')
};
...
exports.tcpSerial = {
	connect : function () {
		...
		var socket = exports.drivers.tcpSerial.connect(port, host, options);

		socket.attach(exports.transports.tcpSerial.prepare(options), next);
	},
	server : function () {
		var options = {};
		var next    = noop;
		...
		return exports.drivers.tcpSerial.server(options).attach(exports.transports.tcpSerial.prepare(options), next);
	}
};
